    ...
    return (
        <>
            <div className='ml-10 mt-5 mb-5 flex flex-col justify-center text-2xl font-bold bg-green-200 w-1/4 h-1/6 items-center'>
                <h1>Total : $
                    {
                        orders.map(item => parseFloat(item.Price * count)).reduce((total, value) => total + value, 0)
                    }
                </h1>
                <h1>Items :
                    {
                        orders.map(index => parseFloat(index.count))
                    }
                </h1>
            </div>
                                ...
                                <div className="w-full bg-white px-10 py-10">
                                    ...
                                    <div className="flex items-center  -mx-8 px-6 py-5">
                                        ...
                                        <div className="flex justify-center w-1/5">
                                            <svg className="fill-current text-gray-600 w-4 cursor-pointer " viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" onClick={decrement} />
                                            </svg>

                                            <span className='mx-5 text-lg'>{count}</span>
                                        ...
                                        <span className="text-center w-1/5 font-semibold text-lg">${e.Price * count}</span>
